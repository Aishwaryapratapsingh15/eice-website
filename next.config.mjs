...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Old flat service URLs â†’ new /services/slug structure
      ...
      // Old flat industry URLs â†’ new /industries/slug structure
      ...
      // Case-sensitive Resources URL (capital R on Linux servers = separate URL)
