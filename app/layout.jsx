  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Poppins (Google Fonts) is only used on /products/eicerise and
            /products/easylogy — its <link> lives in those routes' own
            layout.jsx so the rest of the site (which doesn't use Poppins)
            isn't blocked on it. */}
