...
export const metadata = {
  ...
  description: "EICE Rise Enterprise Suite â€” comprehensive hospitality ERP for large hotel groups with all modules including room booking, POS, payroll, and advanced analytics.",
  ...
  twitter: { card: "summary_large_image", title: "Enterprise Suite Pricing | EICE Rise Hospitality ERP", description: "EICE Rise Enterprise Suite â€” comprehensive hospitality ERP for large hotel groups with all modules including room booking, POS, payroll, and advanced analytics." },
