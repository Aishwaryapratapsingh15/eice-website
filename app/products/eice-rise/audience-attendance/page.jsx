...
export const metadata = {
  ...
  description: "Manage event attendance and audience tracking with EICE Rise Audience Attendance module â€” check-in management, capacity tracking, and event analytics.",
  ...
  twitter: { card: "summary_large_image", title: "Audience Attendance | EICE Rise Hospitality ERP", description: "Manage event attendance and audience tracking with EICE Rise Audience Attendance module â€” check-in management, capacity tracking, and event analytics." },
