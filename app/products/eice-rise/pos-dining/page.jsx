...
export const metadata = {
  ...
  description: "Manage restaurant and hotel dining operations with EICE Rise POS module â€” order management, kitchen display, table billing, and menu configuration for F&B excellence.",
  ...
  twitter: { card: "summary_large_image", title: "POS & Dining | EICE Rise Hospitality ERP", description: "Manage restaurant and hotel dining operations with EICE Rise POS module â€” order management, kitchen display, table billing, and menu configuration for F&B excellence." },
