...
const enterprise = "https://d3r43jacxrwsrp.cloudfront.net/Service_and_technology/enterpise.jpg";
          ...
          <div className="flex lg:flex-row flex-col py-12 sm:py-20 items-center">
            ...
            <div className="lg:flex hidden items-center justify-end ">
              <div className=" w-7/12">
                <img src={enterprise} alt="Enterprise application development services" className="rounded-full"  width="1024" height="603" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
              <p className="font-medium text-blackk/70 sm:text-xl text-[16px] ">
                ...
                design, robust development, and ongoing maintenance and support.</p>
                <p className="font-medium text-blackk/70 sm:text-xl text-[16px]">
