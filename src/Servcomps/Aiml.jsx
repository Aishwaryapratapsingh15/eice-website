...
function Aiml() {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
              ...
              <p className="font-medium text-blackk/70 sm:text-xl text-[16px]  py-4">
      ...
      <div className="max-w-7xl mx-auto">
        <h1 className="text-bloo sm:text-center text-xs font-extrabold uppercase tracking-[0.12em]  py-2">
          Core Competencies
        </h1>
      ...
      <div className="bg-zinc-50 sm:pb-12 sm:my-4">
        ...
        <div className="max-w-7xl mx-auto">
          <h1 className="text-bloo text-xs font-extrabold uppercase tracking-[0.12em]  flex items-start sm:items-center sm:justify-center">
            Why Choose EICE
          </h1>
