...
const cloud = "https://d3r43jacxrwsrp.cloudfront.net/Service_and_technology/cloud.jpg";
...
function Chatbot() {
  return (
    <div>
      <div className="bg-gradient-to-r from-transparent via-bloo/5 to-bloo/10 pt-4 px-4 md:px-10 lg:px-20 xl:px-40">
          ...
          <div className="flex lg:flex-row flex-col py-12 sm:py-20 items-center">
            ...
            <div className="lg:flex hidden items-center justify-end ">
              <div className="lg:w-7/12 w-1/2">
                {/* <img src={cloud} alt="Cloud computing services" className="rounded-full"  width="1" height="1" /> */}
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
              <div className="font-medium text-blackk/70 sm:text-xl text-[16px] ">
                ...
                pivotal role in providing scalable resources, improving
                collaboration, and reducing IT costs.
                <div className="py-2" />
      ...
      <div className="relative font-manrope py-4 lg:pt-24 pt-12 pb-20 px-4 md:px-10 lg:px-20 xl:px-40">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/70 sm:text-xl text-[16px] ">
                ...
                adoption, and create a roadmap for successful implementation.
              </p>
            </div>
          </div>
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
          ...
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/70 sm:text-xl text-[16px] ">
                ...
                and compliance management to ensure your data is secure.
              </p>
            </div>
          </div>
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/70 sm:text-xl text-[16px] ">
                ...
                as code to enhance efficiency and speed up deployment.
              </p>
            </div>
          </div>
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
