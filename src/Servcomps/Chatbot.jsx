  ...
  return (
    <div>
        ...
        <div className="relative font-manrope max-w-7xl mx-auto ">
          ...
          <div className="flex lg:flex-row flex-col py-12 sm:py-20 items-center">
            ...
            <div className="lg:flex hidden items-center justify-end ">
              <div className=" w-1/2">
                <img src={bot} alt="AI chatbot and conversational assistant development" className="rounded-full"  width="300" height="300" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative font-manrope px-4 md:px-10 lg:px-20 xl:px-40 py-4 lg:pt-24 pt-12 pb-20  ">
        ...
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 sm:gap-6 gap-4 sm:pt-8 pt-4">
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            <div className="rounded-full flex items-start w-full">
              <RiAppsLine size={48} className="text-bloo" />
            </div>
          ...
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            <div className=" rounded-full  flex items-start w-full">
              <GiArtificialIntelligence size={48} className="text-bloo" />
            </div>
            <div className="pt-2 h-full text-left">
              <h1 className="text-blackk fontweight_1 text-xl pt-1 pb-3 sm:text-2xl">
          ...
          <div className="group p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            <div className=" rounded-full  flex items-start w-full">
              <GrVmMaintenance size={48} className="text-bloo" />
            </div>
            <div className="pt-2 h-full text-left">
              <h1 className="text-blackk fontweight_1 text-xl pt-1 pb-3 sm:text-2xl">
