  ...
  return (
    <div className="">
      <div className=" relative font-manrope mx-auto px-5 sm:px-1 sm:max-w-7xl w-screen pb-0">
        ...
        <h2 className="text-blackk/70 font-semibold max-w-5xl mx-auto sm:text-2xl pt-4 pb-2 text-[18px] sm:leading-tight leading-snug px-1 text-left sm:text-center">
      ...
      <div className="py-">
        ...
        <div className="bg-zinc-50 pt-4">
          <div className="pt-2 pb-4 relative font-manrope mx-auto px-5 sm:px-1 sm:max-w-7xl w-screen">
            ...
            <div>
              <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 pt-2">
                <Link
                  to="/services/digital-transformation"
                  className="group cursor-pointer p-4 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-gray-200"
                >
                  <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 ">
                    ...
                    <div>
                      <div className="flex flex-col p-2 text-start justify-end">
                        <h1 className="text-blackk fontweight_1 text-[24px] sm:text-2xl pt-1 pb-3">
                          DIGITAL TRANSFORMATION
                        </h1>
                        <p className="z-20 font-medium text-blackk/70 text-[16px]">
      ...
      <div className="">
        ...
        <div className="py-4 relative font-manrope mx-auto px-5 sm:px-1 sm:max-w-7xl w-screen">
          ...
          <div>
            <div className="grid xl:grid-cols-3 lg:grid-cols-3 grid-cols-1 gap-4 pt-2">
              <Link
                to="/services/ai-ml"
                className="group cursor-pointer p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-gray-200 "
              >
                <div className="rounded-full">
                  <LuBrainCircuit size={50} className="text-bloo" />
                </div>
                <div className="pt-4 h-full text-left">
                  <h1 className="text-blackk fontweight_1 text-[24px] sm:text-2xl pb-3">
                    AI & ML
                  </h1>
                  <p className="font-medium text-blackk/70 text-[16px] text-left">
      ...
      <div className="bg-zinc-50" id="appDevelopment">
        <div className="py-4 relative font-manrope mx-auto px-5 sm:px-1 sm:max-w-7xl w-screen">
          ...
          <div className="">
            <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 pt-2">
              <Link
                to="/services/saas"
                className="group cursor-pointer p-4 sm:p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-gray-200"
              >
              ...
              >
                ...
                <div className="pt-2 h-full text-left ">
                  <h1 className="text-blackk fontweight_1 text-[24px] sm:text-2xl mb-3">
                    WEB APP DEVELOPMENT
                  </h1>
                  <p className="font-medium text-blackk/70 text-[16px] text-left">
          ...
          <div style={appStyle} className={`${styles.appConsult}`}>
            ...
            <div className={`${styles.text}`}>
              <div className="">
                <FaPeopleArrows
                  size={50}
                  className="text-bloo lg:hidden pr-2 "
                />
                <FaPeopleArrows
                  size={50}
                  className="text-bloo hidden lg:block pr-2"
                />
                <div>
                  <h1 className="py-2 text-[24px] sm:text-3xl fontweight_1">App Consulting</h1>
                  <p className="text-wrap text-[16px] font-medium" style={{color:"#333333b3"}}>
                    EICE provides expert guidance on app strategy, development,
                    and optimization. Our consultants help you make informed
                    decisions about technology stack, user experience, and
                    market positioning to ensure your app's success.
        ...
        <Link  to="/services/ui-ux">
          <div style={uiuxStyle} className={`${styles.uiuxConsult}`}>
            ...
            <div className={`${styles.text}`}>
              ...
              <div className="">
                <FaPencilRuler size={50} className="text-bloo lg:hidden pr-2 " />
                <FaPencilRuler
                  size={50}
                  className="text-bloo hidden lg:block pr-2"
                />
                <div>
                  <h1 className="py-2 text-[24px] sm:text-3xl fontweight_1">UI/UX Consulting</h1>
                  <p className="text-wrap text-[16px] font-medium" style={{color:"#333333b3"}}>
                    EICE offers specialized UI/UX consulting services to enhance
                    your digital products. Our experts provide insights on user
                    interface design and user experience. We help you create
