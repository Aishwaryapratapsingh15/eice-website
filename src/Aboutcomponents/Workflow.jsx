...
function Workflow() {
  return (
    <div className="font-manrope mx-auto sm:px-4 px-4 sm:max-w-7xl w-screen sm:pt-24 pt-20 sm:pb-24 pb-16">
      ...
      <div className="flex flex-col sm:items-center sm:justify-center items-start text-center">
      ...
      <div className="py-4">
        <div className="flex flex-col sm:items-center sm:justify-center items-start text-center text-blackk">
        ...
        <div className="lg:flex lg:flex-row flex flex-col sm:pt-12 pt-12 sm:items-center sm:justify-center items-start justify-start">
