    ...
    <div className="">
      <div className="max-w-7xl mx-auto px-4 2xl:pt-12 pt-32">
        <div className="w-full">
          <h1 className="text-bloo fontweight_1 text-center fontsize_2 py-2">Product Review Sentiment Analysis</h1>
        ...
        <div className="w-full pb-6">
          ...
          <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
            <div className="flex gap-4">
              ...
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Processing high volumes of unstructured review text from multiple platforms in multiple languages</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Accurately classifying sentiment at both review level and feature/aspect level within each review</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Distinguishing genuine sentiment from sarcasm, mixed opinions, and domain-specific language</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Surfacing trends and anomalies in customer feedback in near real time as new reviews arrive</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">05</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Presenting findings in an accessible dashboard for non-technical business stakeholders</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start justify-end">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">We designed an aspect-based sentiment analysis pipeline that goes beyond overall star ratings, attributing sentiment to specific product features and themes — giving teams granular insight into exactly what customers love or want improved.</p>
              </div>
            </div>
          </div>
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
      ...
      <div className="w-full pb-20 px-4">
        ...
        <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">01</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Delivered aspect-level sentiment classification providing granular insight beyond overall star ratings</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Near real-time review processing enabled faster identification of quality issues and emerging customer concerns</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Product and marketing teams gained self-service access to actionable sentiment insights through an intuitive dashboard</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Automated alerts for sudden sentiment shifts reduced time to respond to product incidents and customer complaints</p>
          </div>
        </div>
      </div>
      <div className="w-full pb-20 px-4">
