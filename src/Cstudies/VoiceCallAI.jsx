    ...
    <div className="">
      <div className="max-w-7xl mx-auto px-4 2xl:pt-12 pt-32">
        <div className="w-full">
          <h1 className="text-bloo fontweight_1 text-center fontsize_2 py-2">Voice Call Assistant</h1>
        ...
        <div className="w-full pb-6">
          ...
          <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
            <div className="flex gap-4">
              ...
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Achieving high speech recognition accuracy across diverse accents, languages, and noisy call environments</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Handling complex, multi-turn conversations and context switching without losing conversational coherence</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Integrating seamlessly with existing CRM and telephony infrastructure with minimal disruption</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Ensuring low latency responses to maintain a natural, real-time conversational experience for callers</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">05</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Providing actionable analytics and call summaries to supervisors without manual review of recordings</p>
            </div>
          </div>
        </div>
      </div>
      <div className="bg-zinc-50 py-12 mt-12">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">About the Project</h1>
          ...
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start justify-end">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">We designed a conversational AI layer that sits between the telephony system and the CRM, handling routine queries autonomously, escalating complex cases to human agents with full context, and capturing structured call data for analytics — all in real time.</p>
              </div>
            </div>
          </div>
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start justify-end">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">We integrated a speech-to-text engine, a domain-specific NLU model, and a dialogue management system into a low-latency pipeline. The assistant was trained on historical call transcripts and integrated with the client's CRM via REST APIs, enabling personalised responses and automatic call summarisation.</p>
              </div>
            </div>
          </div>
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">The AI assistant automated resolution of routine queries, reduced average handle time, and improved first-call resolution rates. Supervisors gained access to automated call summaries and sentiment trends, enabling targeted agent coaching.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full pb-20 px-4">
        ...
        <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">01</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Automated resolution of high-volume routine queries, significantly reducing agent workload</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Reduced average handle time and improved first-call resolution rates through intelligent routing and context handover</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Automated call summarisation eliminated manual note-taking and improved CRM data quality</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Real-time sentiment analytics empowered supervisors with actionable insights for agent coaching</p>
          </div>
        </div>
      </div>
      <div className="w-full pb-20 px-4">
            ...
            <Link href="/case-studies/sentimental-ai" className="p-2 md:p-4">
              <div className="bg-white rounded-lg shadow-md overflow-hidden h-full">
                <div className="p-3 md:p-4">
                  ...
                  <p className="text-blackk/60 fontsize_3 fontweight_1 text-left">Enhancing Product Insights with AI-Powered Sentiment Analysis</p>
                </div>
              </div>
            </Link>
          </div>
            ...
            <Link href="/case-studies/logistics-ai" className="p-2 md:p-4">
              <div className="bg-white rounded-lg shadow-md overflow-hidden h-full">
                <div className="p-3 md:p-4">
                  ...
                  <p className="text-blackk/60 fontsize_3 fontweight_1 text-left">Transforming Logistics Operations with AI</p>
                </div>
              </div>
            </Link>
          </div>
            ...
            <Link href="/case-studies/inventory-ai" className="p-2 md:p-4">
              <div className="bg-white rounded-lg shadow-md overflow-hidden h-full">
                <div className="p-3 md:p-4">
                  ...
                  <p className="text-blackk/60 fontsize_3 fontweight_1 text-left">Revolutionizing Inventory Management with AI</p>
                </div>
              </div>
            </Link>
          </div>
