    ...
    <div className="">
      <div className="max-w-7xl  mx-auto px-4 2xl:pt-12 pt-32">
        <div className="w-full">
          ...
          <div className="w-full max-w-7xl mx-auto items-center justify-center pt-8 pb-4 grid grid-cols-1 gap-4">
            <img
              src={scadanoralta1.src}
              alt=""
              className="object-fit justify-self-center"
            />
          </div>
        </div>
