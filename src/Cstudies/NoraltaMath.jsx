    ...
    <div className="">
      <div className="max-w-7xl mx-auto px-4 pt-4">
        <div className="w-full">
          <h2 className="text-blackk fontweight_1 text-center text-[32px] py-2">FEMMS</h2>
      ...
      <section className="bg-[#012060] py-4 sm:py-10 px-5 sm:px-6 md:px-10 lg:px-20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[32px] sm:text-4xl font-bold text-white mb-4 leading-tight">Ready to Prove Your Emissions Compliance?</h2>
          <p className="text-blue-200 text-[16px] sm:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">Talk to our team about fugitive emissions monitoring, estimation, and management systems.</p>
