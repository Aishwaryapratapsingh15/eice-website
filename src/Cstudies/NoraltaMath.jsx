    ...
    <div className="">
      <div className="max-w-7xl mx-auto px-4 2xl:pt-12 pt-32">
        <div className="w-full">
          <h1 className="text-bloo fontweight_1 text-center fontsize_2 py-2">FEMMS</h1>
        ...
        <div className="w-full pb-6">
          ...
          <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
            <div className="flex gap-4">
              ...
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Accurately detecting and quantifying fugitive emissions from diverse equipment types across large facilities</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Automating emission estimation calculations in compliance with EPA and local regulatory methodologies</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Managing inspection schedules, repair workflows, and re-inspection tracking for thousands of components</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Generating audit-ready regulatory reports with full data traceability and evidence documentation</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">05</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Supporting mobile data collection by field technicians in areas with limited connectivity</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start justify-end">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">We envisioned a component-level LDAR platform that digitises every step of the fugitive emission lifecycle — from initial survey and leak detection, through estimation and repair scheduling, to final regulatory reporting — in one integrated system.</p>
              </div>
            </div>
          </div>
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
          ...
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">FEMMS transformed Noralta's emissions management from a manual, error-prone process into a fully auditable digital programme. Regulatory reporting time was dramatically reduced, repair SLAs improved, and the system provided a defensible data trail for environmental audits.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full pb-20 px-4">
        ...
        <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">01</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Delivered a fully digital LDAR system replacing paper-based processes across all Noralta facilities</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Automated emission estimation using EPA-approved methodologies, eliminating manual calculation errors</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Significantly reduced regulatory reporting preparation time through automated report generation</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Provided a complete audit trail for environmental compliance, supporting regulatory inspections with full data traceability</p>
          </div>
        </div>
      </div>
      <ProductFooter />
