    ...
    <div className="">
      <div className="max-w-7xl mx-auto px-4 2xl:pt-12 pt-32">
        <div className="w-full">
          <h1 className="text-bloo fontweight_1 text-center fontsize_2 py-2">Business Analytics Automation</h1>
        ...
        <div className="w-full pb-6">
          ...
          <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
            <div className="flex gap-4">
              ...
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Aggregating financial and production data from multiple source systems into a coherent analytical model</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Automating the refresh and recalculation of complex petroleum financial models on a scheduled basis</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Delivering actionable KPI dashboards accessible to both financial and technical stakeholders</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Ensuring data accuracy and reconciliation across heterogeneous upstream and financial data sources</p>
            </div>
            <div className="flex gap-4">
              <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">05</h1>
              <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Supporting scenario modelling and sensitivity analysis for forward-looking petroleum economics</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start justify-end">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">We designed a centralised analytics engine that automatically ingests upstream production and cost data, runs petroleum financial model calculations, and presents results through role-specific dashboards — eliminating manual spreadsheet workflows.</p>
              </div>
            </div>
          </div>
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
          ...
          <div className="group cursor-pointer p-4 bg-zinc-50 rounded-md overflow-hidden shadow-sm transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200">
            <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
              ...
              <div className="flex flex-col p-2 text-start">
                ...
                <p className="z-20 fontweight_1 text-blackk/60 fontsize_3">The platform eliminated manual financial model updates and reduced reporting cycle time. Scenario modelling capabilities improved the speed and confidence of investment decisions across Schlumberger's global project portfolio.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full pb-20 px-4">
        ...
        <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">01</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Delivered an automated petroleum financial model monitoring platform eliminating manual spreadsheet workflows</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">02</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Reduced financial reporting cycle time significantly through scheduled automated model recalculation</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">03</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Scenario modelling tools accelerated investment decision-making across Schlumberger's global project portfolio</p>
          </div>
          <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
            <h1 className="text-bloo flex items-center justify-center h-full fontweight_1 text-center fontsize_2 py-2">04</h1>
            <p className="fontweight_1 text-blackk/60 fontsize_3 py-2">Role-specific dashboards improved cross-functional alignment between financial and technical teams</p>
          </div>
        </div>
      </div>
      <ProductFooter />
