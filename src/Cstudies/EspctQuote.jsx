    ...
    <div className="">
      ...
      <section className="bg-[#012060] py-4 sm:py-10 px-4 md:px-10 lg:px-20 xl:px-40">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[32px] sm:text-4xl font-bold text-white mb-4 leading-tight">Looking to Modernize Your Sales &amp; Quotation Process?</h2>
          <p className="text-blue-200 text-[16px] sm:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">Talk to our team about building a web-based quotation platform for your equipment or services.</p>
